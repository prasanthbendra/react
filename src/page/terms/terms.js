...
export default class Terms extends React.Component {
    ...
    render(){
        return (
            <Page title="Terms and Conditions" description="Pellentesque habitant morbi tristique senectus et netus et malesuada">
                <section id="terms" class="container body-section">
                    <h3>Introduction</h3>
